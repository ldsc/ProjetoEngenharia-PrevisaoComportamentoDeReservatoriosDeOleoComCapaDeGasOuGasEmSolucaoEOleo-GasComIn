...
class CRK4
{
      ...
      public: 
      		CRK4(CMuskat& obj):i(0){
                         ...
                         std::cout << std::endl;
                         std::cout<<"Escolha os parametros da simulacao"<<'\n';
                         std::cout<<"Entre com o passo (Se a pressao estiver caindo, entre o passo com sinal negativo): " << '\n';
                         std::cin>>dx;
                         std::cin.get();
                         std::cout <<"Até que pressao deseja prever?" << '\n';
                         std::cin>>aux2;
                         std::cin.get();
