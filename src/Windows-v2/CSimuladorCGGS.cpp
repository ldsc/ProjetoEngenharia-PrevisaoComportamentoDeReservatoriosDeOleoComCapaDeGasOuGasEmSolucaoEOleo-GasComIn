...
void CSimuladorCGGS::SalvaGraf(CGnuplot& graf){
	std::cout<<"Deseja salvar o gráfico? 1-SIM 2-NAO"<<'\n';
	int op;
...
void CSimuladorCGGS::Grafico_Sim(){   
    ...
    std::cout<<"Qual gráfico das propriedades dos fluídos de reservatório desejas plotar?" <<'\n';
...
void CSimuladorCGGS::Resultados(std::ostream& os){
	os<<"A seguir os dados da simulação:"<<'\n';
	os<<"-------------------------------------------------------------------------------------------------"<<'\n';      
os << "Pressão" << std::setw(12) << "Bo" << std::setw(12) << "dBo/dP" << std::setw(12) << "1/Bg" <<std::setw(12) << "d(1/Bg)/dP" <<std::setw(12) << "Rs" <<std::setw(12) << "dRs/dP" <<std::setw(12) << "uo/ug" <<std::endl;
...
void CSimuladorCGGS::SaidaDisco(std::ofstream& fout){
	fout<<"A seguir os dados da simulação:"<<'\n';
	fout<<"-------------------------------------------------------------------------------------------------"<<'\n';
	fout << "Pressão" << std::setw(12) << "Bo" << std::setw(12) << "dBo/dP" << std::setw(12) << "1/Bg" <<std::setw(12) << "d(1/Bg)/dP" <<std::setw(12) << "Rs" <<std::setw(12) << "dRs/dP" <<std::setw(12) << "uo/ug" <<std::endl;
...
void CSimuladorCGGS::P(){      
       double pressure;
       std::cout <<"Entre com os dados da pressões medidas de reservatório! Digite um valor menor que 0 para sair do loop (visto que não há pressões negativas no reservatório)"<<'\n';
       do{
         std::cout <<"Digite a pressão em kgf/cm^2"<<'\n';
...
void CSimuladorCGGS::BO(){
       double bo_aux; 
       std::cout <<"Entre com os valores de Bo referentes à cada pressão preenchida por você anteriormente neste programa." <<'\n';
       for(int i=0;i<var_ctrl;i++){
          std::cout << "Digite o valor de Bo para a pressão de "<< p[i]<<" kgf/cm^2"<< '\n';
...
void CSimuladorCGGS::INVBG(){
       ...
       std::cout <<"Entre com os valores de Bg referentes à cada pressão preenchida por você anteriormente neste programa." <<'\n';
       for(int i=0;i<var_ctrl;i++){
          std::cout << "Digite o valor de Bg para a pressão de "<< p[i]<<" kgf/cm^2"<< '\n';
...
void CSimuladorCGGS::RS(){
       ...
       std::cout <<"Entre com os valores de Rs referentes à cada pressão preenchida por você anteriormente neste programa." <<'\n';
       for(int i=0;i<var_ctrl;i++){
          std::cout << "Digite o valor de Rs para a pressão de "<< p[i]<<" kgf/cm^2"<< '\n';
...
void CSimuladorCGGS::MIO_MIG(){
       std::cout<<"Insira os valores das viscosidades do óleo em cp" <<'\n';
       double miaux;
       for(int i=0;i<var_ctrl;i++){
              std::cout << "Digite o valor de Mio para a pressão de "<< p[i]<<" kgf/cm^2"<< '\n';
              std::cin>>miaux; std::cin.get();
              mio.push_back(miaux);
       }
       
       std::cout<<"Insira os valores das viscosidades do gás em cp" <<'\n';
       for(int j=0;j<var_ctrl;j++){
              std::cout << "Digite o valor de Mig para a pressão de "<< p[j]<<" kgf/cm^2"<< '\n';
              std::cin>>miaux; std::cin.get();
              mig.push_back(miaux);   
       }
...
void CSimuladorCGGS::KG_KO(){
       std::cout<<"Insira os valores das permeabilidades do óleo em cp" <<'\n';
       double koaux;
       for(int i=0;i<var_ctrl;i++){
              std::cout << "Digite o valor de Ko para a pressão de "<< p[i]<<" kgf/cm^2"<< '\n';
              std::cin>>koaux; std::cin.get();
              ko.push_back(koaux);
       }
       std::cout<<"Insira os valores das permeabilidades do gás em cp" <<'\n';
       double kgaux;
       for(int j=0;j<var_ctrl;j++){
              std::cout << "Digite o valor de Kg para a pressão de "<< p[j]<<" kgf/cm^2"<< '\n';
...
std::ostream& operator<<(std::ostream& out, CSimuladorCGGS& obj){
	std::cout<<"Vamos mostrar os vetores até agora:"<<'\n';
    std::cout<<"Vetor Pressão:"<<'\n';
