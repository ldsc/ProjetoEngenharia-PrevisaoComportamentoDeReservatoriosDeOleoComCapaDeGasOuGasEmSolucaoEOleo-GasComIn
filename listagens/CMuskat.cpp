...
void CMuskat::Saida(std::ostream& os){
	   	...
	   	os<<'\n';
		os<<"-------------------------------------------------------------------------------------------------"<<'\n';
		os<<"A seguir, os parâmetros de cálculo da Eq. de Muskat:"<<'\n';
		os<<"-------------------------------------------------------------------------------------------------"<<'\n';
...
void CMuskat::SaidaDisco(std::ofstream& fout){
	...
	fout<<'\n';
	fout<<"-------------------------------------------------------------------------------------------------"<<'\n';
	fout<<"A seguir, os parâmetros de cálculo da Eq. de Muskat:"<<'\n';
	fout<<"-------------------------------------------------------------------------------------------------"<<'\n';
...
void CMuskat::Grafico(){
	std::cout<<"Método Gráfico CMuskat"<<'\n';
...
void CMuskat::SaidaResumida(){
	...
	system("clear");
	#endif
	cout<<"A tabela a seguir contém os resultados resumidos de maior interesse para o usuário do programa"<<'\n';
